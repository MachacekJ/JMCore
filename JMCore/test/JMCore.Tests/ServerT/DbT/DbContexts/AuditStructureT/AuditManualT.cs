...
public class AuditManualT : AuditStructureBaseT
{
  ...
  public async Task AddItem()
  {
    ...
    await RunTestAsync(method, async () =>
    {
      ...
      TestBasicPGDbContext.TestManualAudits.Add(item);
      await TestBasicPGDbContext.SaveChangesAsync();

      // Assert.
      Assert.True(TestBasicPGDbContext.TestManualAudits.Count() == 1);
  ...
  public async Task DeleteItem()
  {
    ...
    await RunTestAsync(method, async () =>
    {
      ...
      TestBasicPGDbContext.TestManualAudits.Remove(item);
      await TestBasicPGDbContext.SaveChangesAsync();

      // Assert.
      Assert.True(!TestBasicPGDbContext.TestManualAudits.Any());
