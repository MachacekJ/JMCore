...
// using JMCore.Server.MSSQLStorage.AuditStructure.Models;
// using JMCore.Server.MSSQLStorage.AuditStructure.Scripts;
...
//
// namespace JMCore.Server.MSSQLStorage.AuditStructure;
//
...
//         });
//
//     public AuditDbContext(DbContextOptions<AuditDbContext> options, IMediator mediator, ILogger<AuditDbContext> logger)
