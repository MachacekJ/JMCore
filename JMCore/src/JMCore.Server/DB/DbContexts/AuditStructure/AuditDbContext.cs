...
using JMCore.Server.DB.DbContexts.AuditStructure.Scripts.Postgres;
...
public class AuditPGDbContext : DbContextBase, IAuditDbContext
{
  ...
  public AuditPGDbContext(DbContextOptions<AuditPGDbContext> options, IMediator mediator, ILogger<AuditPGDbContext> logger)
