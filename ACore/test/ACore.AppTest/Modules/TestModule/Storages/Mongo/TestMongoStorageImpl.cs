...
internal class TestMongoStorageImpl(DbContextOptions<TestMongoStorageImpl> options, IMediator mediator, ILogger<TestMongoStorageImpl> logger, IAuditDbService auditService) : TestStorageEfContext(options, mediator, logger, auditService)
{
