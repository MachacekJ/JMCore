...
internal class BasicSqlMongoEfStorageImpl : BasicSqlStorageImpl
{
  ...
  public BasicSqlMongoEfStorageImpl(DbContextOptions<BasicSqlMongoEfStorageImpl> options, IMediator mediator, ILogger<BasicSqlMongoEfStorageImpl> logger)
    : base(options, mediator, logger)
  {
  }

  public BasicSqlMongoEfStorageImpl(DbContextOptions<BasicSqlMongoEfStorageImpl> options, IMediator mediator, IAuditConfiguration? auditConfiguration, ILogger<BasicSqlMongoEfStorageImpl> logger)
    : base(options, mediator, auditConfiguration, logger)
  {
  }
