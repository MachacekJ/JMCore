...
public class AuditDbService : IAuditDbService
{
    ...
    private readonly IAuditDbConfiguration _auditConfiguration;

    public AuditDbService(IAuditDbContext auditDbContext, IAuditDbConfiguration auditConfiguration, IAuditUserProvider? auditUserProvider)
    {
