...
using JMCore.Server.DataStorages.PG.BasicStructure.Models;
...
namespace JMCore.Server.DataStorages.PG.BasicStructure;

public class BasicPGDbContext : DbContextBase, IBasicDbContext
{
  ...
  public BasicPGDbContext(DbContextOptions<BasicPGDbContext> options, IMediator mediator, ILogger<BasicPGDbContext> logger) : this(options, mediator, null, logger)
  {
  }

  public BasicPGDbContext(DbContextOptions<BasicPGDbContext> options, IMediator mediator, IAuditDbService? auditService, ILogger<BasicPGDbContext> logger) : base(options, mediator, logger, auditService)
  {
    _logger = logger;
  }
