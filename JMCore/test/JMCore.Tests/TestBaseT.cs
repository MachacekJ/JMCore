...
public abstract class TestBaseT
{
    ...
    protected ILogger<TestBaseT> Log { get; set; } = null!;
    ...
    protected virtual void RegisterAutofacContainer(ServiceCollection services, ContainerBuilder containerBuilder)
    {
        ...
        var configuration = MediatRConfigurationBuilder
            .Create(typeof(TestBaseT).Assembly, typeof(JMCacheKey).Assembly)
    ...
    protected virtual void RegisterServices(ServiceCollection services)
    {
        ...
        {
            c.RegisterServicesFromAssemblyContaining<TestBaseT>();
    ...
    {
        Log = sp.GetService<ILogger<TestBaseT>>() ?? throw new ArgumentException($"{nameof(ILogger<TestBaseT>)} is null.");
