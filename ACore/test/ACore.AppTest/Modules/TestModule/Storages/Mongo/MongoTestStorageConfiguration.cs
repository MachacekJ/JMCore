...
//
// public class MongoTestStorageConfiguration(string connectionString, string dbName, IEnumerable<string> requiredStorageModules) 
//   : MongoStorageConfiguration(connectionString, dbName, requiredStorageModules)
// {
...
//       {
//         services.AddTestServiceModuleOld();
...
//       if (requiredStorageModule == nameof(IEFTestStorageModule))
//       {
//         await serviceProvider.UseTestServiceModule();
