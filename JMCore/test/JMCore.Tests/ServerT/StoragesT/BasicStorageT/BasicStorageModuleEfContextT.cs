...
public class BasicStorageModuleEfContextT : DbBaseT
{
  ...
  protected override void RegisterServices(ServiceCollection sc)
  {
    ...
    StorResolver.RegisterStorage(sc, new MemoryStorageConfiguration("memory", StorageNativeModuleTypeEnum.BasicModule));
  }

  protected override async Task GetServicesAsync(IServiceProvider sp)
  {
    await base.GetServicesAsync(sp);
    Db = StorResolver.StorageModuleImplementation<IBasicStorageModule>(StorageTypeEnum.Memory);
  }
}